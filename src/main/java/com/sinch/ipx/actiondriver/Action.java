package com.sinch.ipx.actiondriver;
...
public class Action extends Testbase {
	...
	public static void implicitWait(WebDriver driver, long iMPLICIT_WAIT) {
	...
	public static void pageLoadTimeOut(WebDriver driver, long pAGE_LOAD_TIMEOUT) {
